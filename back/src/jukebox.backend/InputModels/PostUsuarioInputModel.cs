...
{
    public class PostUsuarioInputModel
    {
    ...
    public class PostUsuarioInputModelValidador : AbstractValidator<PostUsuarioInputModel>
    {
        public PostUsuarioInputModelValidador()
        {
            RuleFor(x => x.Nome)
